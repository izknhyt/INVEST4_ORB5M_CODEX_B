...
def save_run(out_dir: str, symbol: str, mode: str, params: Dict[str,Any], metrics, state: Dict[str,Any] | None = None) -> str:
    ...
    with open(index_path, "a", newline="") as f:
        cols = [
            ...
            "trades","wins","total_pips","state_path"
        ]
...
def run_grid(argv=None) -> Dict[str,Any]:
    ...
    for idx, (or_n, k_tp, k_sl) in enumerate(combos, 1):
        ...
        rcfg = RunnerConfig(
            threshold_lcb_pip=rcfg_base.threshold_lcb_pip,
            slip_cap_pip=rcfg_base.slip_cap_pip,
            min_or_atr_ratio=rcfg_base.min_or_atr_ratio,
            rv_band_cuts=rcfg_base.rv_band_cuts,
            spread_bands=rcfg_base.spread_bands,
            allow_low_rv=rcfg_base.allow_low_rv,
            or_n=or_n,
            k_tp=k_tp,
            k_sl=k_sl,
            k_tr=rcfg_base.k_tr,
            warmup_trades=rcfg_base.warmup_trades,
        ...
        params = {
            ...
            "rv_cuts": args.rv_cuts, "allow_low_rv": args.allow_low_rv, "warmup": args.warmup,
        }
