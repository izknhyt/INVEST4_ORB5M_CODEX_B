...
## Next Task
- Re-run 2018–2025 long-horizon simulations for Conservative / Bridge (`python3 scripts/run_sim.py --manifest configs/strategies/day_orb_5m.yaml --csv validated/USDJPY/5m.csv --mode <mode> ...`) to capture updated metrics and draft parameter adjustments for P4-01 長期バックテスト改善。Summarise findings in `docs/progress_phase4.md` and outline follow-up experiments。
